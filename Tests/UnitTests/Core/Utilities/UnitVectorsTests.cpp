...
void testCurvilinear(const Acts::detail::Eagen::MatrixBase<Direction>& direction,
                     const Acts::detail::Eagen::MatrixBase<RefUnitU>& refU,
                     const Acts::detail::Eagen::MatrixBase<RefUnitV>& refV) {
